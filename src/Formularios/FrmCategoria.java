package Formularios;
import Desarrollo.AbmCategoria;
import javax.swing.JOptionPane;
// import javax.swing.DefaultListModel;

public class FrmCategoria extends javax.swing.JInternalFrame {
AbmCategoria ObjCat;
AbmCategoria ObjCat2;
...
String NomViejo = null;
   ...
   //     this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        ListaCategorias.setBackground(new java.awt.Color(204, 153, 0));
    ...
    private void BtnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnActualizarActionPerformed
        ...
        ObjCat2 = new AbmCategoria(NomViejo);
    ...
    //       String Nom = this.TxtNom.getText(); // debe tomar el id y no el nombre
            ObjCat2 = new AbmCategoria();
            ObjCat2.setNom(NomCatBorrar);
            ObjCat2.Baja();
   ...
   private void Visible()
    ...
    private void BtnConsulta1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnConsulta1ActionPerformed
        ...
        this.TxtNom.setVisible(false);
        ObjCat2 = new AbmCategoria();
        ListaCategorias.setModel(ObjCat2.Muestro()); // error de nullpointer
