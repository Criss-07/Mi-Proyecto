...
ArrayList <Integer> Cat=new ArrayList<Integer>();
    ...
    public FrmVentas() {
        ...
        this.TxtInteres.setVisible(true);
    }
private void CargarProductos()
{
  ...
  //          this.ChkDto.setVisible(true);
        ...
        else 
        {
           ...
           ObjDetalleVta4 = new AbmVentas( NomProd.get(i),  precio.get(i),  Cat.get(i),  DidVta,  DidProd, DidCat);
    ...
    private void BtnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCargarActionPerformed
     //   pu = Double.parseDouble(this.TxtPu.getText());
       Producto = this.CbProducto.getSelectedItem().toString();
        ...
        Cat.add(Integer.parseInt(this.TxtCant.getText()));
        precio.add(pu);
