...
public class AbmProductos 
{
    ...
    private String AltaSql = "INSERT INTO productos (NomCom,PrecioLista,FechaVto,CantExistente,Envase,TipoVta,PrecioCosto,categoria_idcategoria,laboratorios_idlaboratorios,droga_iddroga) VALUES (?,?,?,?,?,?,?,?,?,?);";
    private String ConsultaSql = "SELECT * FROM productos;";     
    private String Borrar = "DELETE FROM productos WHERE NomCom = (?);";    
    
    
    private String ListaLabSql = "SELECT * FROM laboratorios;"; 
    ...
    public AbmProductos(String Nom, double PrecioLista, Date FechaVto, int CantExis, String Envase, char TipoVta, double PrecioCosto, int ProdIdCat, int ProdIdLab, int ProIdDrog) {
        this.Nom = Nom;
    ...
    public void Alta(int  VaridLab, int  VaridCat, int  VaridDro)
    {
        try 
        {
            ...
            Instruccion.setInt(8, VaridCat);
            Instruccion.setInt(9, VaridLab);
            Instruccion.setInt(10, VaridDro);
    ...
    public void Modif(String NomNuevo, double PreListNuevo, Date FechaVto,int Cant, String Envase, char TipoVta, double PreCosto, int idCat, int idLab, int idDro)
    {
        
        String Cambia ="UPDATE productos SET  NomCom = '"+ NomNuevo+"', PrecioLista = '"+ PreListNuevo +"', FechaVto = '"+ FechaVto +"', CantExistente = '"+ Cant +"', Envase = '"+ Envase +"', TipoVta = '"+ TipoVta +"', PrecioCosto = '"+ PreCosto +"', categoria_idcategoria = '"+ idCat +"', laboratorios_idlaboratorios = '"+ idLab +"', droga_iddroga = '"+ idDro +"' WHERE NomCom = '"+ this.getNom() +"';";
        try 
        {
    ...
    {
        int VarId = 0;
        String DevuelveIdLabSql =  "SELECT * FROM laboratorios WHERE NomLab = '"+NomLabElegido+"';";
        try 
        {
    ...
    {
        String VarNom = "";
        String DevuelveNomLabSql =  "SELECT * FROM laboratorios WHERE idlaboratorios = '"+IdLabElegido+"';";
        try 
        {
...
/************************/   
    ...
    {
        String BuscarNro = "select NomCom,PrecioLista,FechaVto,CantExistente,Envase,TipoVta,PrecioCosto,categoria_idcategoria,laboratorios_idlaboratorios,droga_iddroga from productos where NomCom = '" + NomProd + "';";
