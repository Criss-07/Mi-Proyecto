...
public class AbmVentas 
{
   ...
   private int DidCat;
    ...
    public AbmVentas(String Nom, double precio, int Cant, int DidProd, int DidCat) {
        this.Nom = Nom;
        this.precio = precio;
        this.Cant = Cant;
  ...
  public DefaultComboBoxModel CargarComboProductos()
  {
   ...
   public void AltaDetalleVta()
    {
        try 
        {
            ...
            Instruccion.setInt(4, this.getDidProd());
            Instruccion.setInt(5, this.getDidCat());
   ...
   public double BuscoidProducto(String NomProdElegido)
    {
        int VarId = 0;
   ...
   public double BuscoidCategoria(String NomProdElegido)
    {
        int VarId = 0;
   ...
   public double BuscoidVtas()
    {
        int VarId = 0;
        String DevuelveidVtaSql =  "SELECT max(idVta) FROM productos;";
        try 
        {
